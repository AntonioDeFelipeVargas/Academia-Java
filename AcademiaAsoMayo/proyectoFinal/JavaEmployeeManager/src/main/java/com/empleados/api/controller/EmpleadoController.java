...
@Tag(name = "EmpleadoModel", description = "API para la gestión de empleados")
public class EmpleadoController {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "EmpleadoModel encontrado",
                    content = @Content(schema = @Schema(implementation = EmpleadoDTO.class))),
        @ApiResponse(responseCode = "404", description = "EmpleadoModel no encontrado",
                    content = @Content)
    })
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "201", description = "EmpleadoModel creado correctamente",
                    content = @Content(schema = @Schema(implementation = EmpleadoDTO.class))),
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "EmpleadoModel actualizado correctamente",
                    content = @Content(schema = @Schema(implementation = EmpleadoDTO.class))),
        @ApiResponse(responseCode = "404", description = "EmpleadoModel no encontrado",
                    content = @Content),
        @ApiResponse(responseCode = "400", description = "Datos inválidos", 
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "204", description = "EmpleadoModel eliminado correctamente"),
        @ApiResponse(responseCode = "404", description = "EmpleadoModel no encontrado",
                    content = @Content)
    })
