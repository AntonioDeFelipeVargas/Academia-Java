...
public class EmpleadoServiceImpl implements EmpleadoService {
    ...
    public EmpleadoDTO getEmpleadoById(Long id) {
        EmpleadoModel empleado = empleadoRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("EmpleadoModel no encontrado con id: " + id));
    ...
    public EmpleadoDTO createEmpleado(EmpleadoDTO empleadoDTO) {
        try {
            ...
            EmpleadoModel empleado = convertToEntity(empleadoDTO);
            EmpleadoModel savedEmpleado = empleadoRepository.save(empleado);
    ...
    public EmpleadoDTO updateEmpleado(Long id, EmpleadoDTO empleadoDTO) {
        EmpleadoModel existingEmpleado = empleadoRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("EmpleadoModel no encontrado con id: " + id));
        ...
        EmpleadoModel updatedEmpleado = empleadoRepository.save(existingEmpleado);
    ...
    public void deleteEmpleado(Long id) {
        if (!empleadoRepository.existsById(id)) {
            throw new ResourceNotFoundException("EmpleadoModel no encontrado con id: " + id);
        }
     ...
     */
    private EmpleadoDTO convertToDTO(EmpleadoModel empleado) {
     ...
     */
    private EmpleadoModel convertToEntity(EmpleadoDTO empleadoDTO) {
