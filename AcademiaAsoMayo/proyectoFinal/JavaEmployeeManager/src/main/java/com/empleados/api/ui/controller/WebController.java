...
public class WebController {
    ...
    public String guardarEmpleado(@Valid @ModelAttribute("empleado") EmpleadoDTO empleado,
        ...
        redirectAttributes.addFlashAttribute("mensajeExito", "¡EmpleadoModel creado correctamente!");
    ...
    public String actualizarEmpleado(@PathVariable Long id, 
        ...
        redirectAttributes.addFlashAttribute("mensajeExito", "¡EmpleadoModel actualizado correctamente!");
        return "redirect:/empleados";
    }
    ...
    public String eliminarEmpleado(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("mensajeExito", "¡EmpleadoModel eliminado correctamente!");
        return "redirect:/empleados";
    }
}