...
class EmpleadoModelControllerTest {
    ...
    void getEmpleadoById_WhenEmpleadoDoesNotExist_ShouldReturn404() throws Exception {
        // Arrange
        when(empleadoService.getEmpleadoById(99L)).thenThrow(new ResourceNotFoundException("EmpleadoModel no encontrado con id: 99"));
    ...
    void updateEmpleado_WhenEmpleadoDoesNotExist_ShouldReturn404() throws Exception {
        ...
        when(empleadoService.updateEmpleado(eq(99L), any(EmpleadoDTO.class)))
                .thenThrow(new ResourceNotFoundException("EmpleadoModel no encontrado con id: 99"));
    ...
    void deleteEmpleado_WhenEmpleadoDoesNotExist_ShouldReturn404() throws Exception {
        // Arrange
        doThrow(new ResourceNotFoundException("EmpleadoModel no encontrado con id: 99"))
