...
class EmpleadoModelTest {
    ...
    private EmpleadoModel empleado1;
    private EmpleadoModel empleado2;
    private EmpleadoModel empleado3; // copia idéntica a empleado1
    private EmpleadoModel empleadoNull;

    @BeforeEach
    void setUp() {
        // Primer objeto
        empleado1 = new EmpleadoModel(
                1L,
                "Juan",
                "Pérez",
    ...
    void testEqualsWithModifiedFields() {
        ...
        EmpleadoModel modified = new EmpleadoModel(
                1L, // mismo ID
    ...
    void testEqualsWithNullId() {
        ...
        EmpleadoModel emp1WithNullId = new EmpleadoModel(
                null,
                "Juan",
                "Pérez",
                "juan.perez@example.com",
        ...
        EmpleadoModel emp2WithNullId = new EmpleadoModel(
                null,
                "Juan",
                "Pérez",
                "juan.perez@example.com",
    ...
    void testEqualsWithAllFieldsNull() {
        EmpleadoModel emptyEmp1 = new EmpleadoModel();
        EmpleadoModel emptyEmp2 = new EmpleadoModel();
