...
class EmpleadoModelServiceTest {
    ...
    void createEmpleado_WithValidData_ShouldReturnCreatedEmpleado() {
        ...
        when(empleadoRepository.save(any(EmpleadoModel.class))).thenReturn(savedEmpleado);
    ...
    void updateEmpleado_WhenEmpleadoExists_ShouldReturnUpdatedEmpleado() {
        ...
        EmpleadoModel updatedEmpleado = new EmpleadoModel(
                1L,
                "Juan Carlos",
                "Pérez",
                "juan.perez@example.com",
        ...
        when(empleadoRepository.findById(1L)).thenReturn(Optional.of(empleado));
        when(empleadoRepository.save(any(EmpleadoModel.class))).thenReturn(updatedEmpleado);
    ...
    void getEmpleadosByDepartamento_ShouldReturnEmpleadosInDepartamento() {
        // Arrange
        List<EmpleadoModel> tecnologiaEmpleados = Arrays.asList(empleado);
    ...
    void convertToDTO_ShouldMapAllProperties() {
        // Arrange
        EmpleadoModel testEmpleado = new EmpleadoModel(
                5L,
                "Test",
                "User",
